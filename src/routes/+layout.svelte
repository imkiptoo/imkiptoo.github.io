...
<div class="flex flex-col h-screen">
	...
	<div class="flex mt-14">
		<div class="flex lg:hidden">
			...
			<div class="fixed flex flex-col justify-between top-14 border-t-light-border dark:border-t-dark-border bottom-0 left-0 z-20 w-full duration-100 transform -translate-x-full bg-neutral-50 dark:bg-dark-bg shadow-lg peer-checked:translate-x-0">
		...
		<div class="flex mx-0 xl:mx-24 2xl:mx-40 overflow-hidden h-[calc(100vh-3.5rem)] w-full">
		...
		<div class="flex lg:hidden">
			...
			<div class="fixed flex flex-col justify-between top-14 border-t-light-border dark:border-t-dark-border bottom-0 right-0 z-10 w-full duration-100 transform translate-x-full bg-neutral-50 dark:bg-dark-bg shadow-lg peer-checked:translate-x-0">
				<div class="flex h-full w-full">
					<div style="writing-mode: vertical-rl" class="min-w-14 cursor-vertical-text flex items-center justify-between pb-3 pt-4">
