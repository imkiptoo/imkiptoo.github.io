...
<div class="flex fixed w-full px-0 md:px-0 lg:px-0 z-50 xl:px-24 2xl:px-40 h-14 justify-between shadow-md dark:shadow-none dark:border-b border-transparent dark:border-dark-border bg-dark-bg dark:bg-dark-bg text-white" id="my-header">
